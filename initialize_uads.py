...
connection.commit()
cursor.execute('INSERT INTO Student VALUES (4, "789 Street", "Mary", 4)')
connection.commit()
...
connection.commit()
cursor.execute('INSERT INTO Instructor VALUES (9, "555 Road", "Terry", "CompEng")')
connection.commit()
cursor.execute('INSERT INTO Instructor VALUES (10, "777 Way", "Bobby", "NucEng")')
connection.commit()
...
connection.commit()
cursor.execute('INSERT INTO Building VALUES ("14 Miner", "Computer Eng Building", "CEB")')
connection.commit()
cursor.execute('INSERT INTO Building VALUES ("15 Miner", "Nuclear Eng Building", "NEB")')
connection.commit()
...
connection.commit()
cursor.execute('INSERT INTO Located VALUES ("CompEng", "14 Miner")')
connection.commit()
cursor.execute('INSERT INTO Located VALUES ("NucEng", "15 Miner")')
connection.commit()
...
connection.commit()
cursor.execute('INSERT INTO Course VALUES ("CE2100", "CompEng", 3)')
connection.commit()
cursor.execute('INSERT INTO Course VALUES ("NE3200", "NucEng", 3)')
connection.commit()
...
connection.commit()
cursor.execute('INSERT INTO Class VALUES ("T0206", "11001",4,"CE2100")')
connection.commit()
cursor.execute('INSERT INTO Class VALUES ("R0106", "10110",5,"NE3200")')
connection.commit()
...
connection.commit()
cursor.execute('INSERT INTO Requires VALUES (4, "CE2100")')
connection.commit()
cursor.execute('INSERT INTO Requires VALUES (5, "NE3200")')
connection.commit()
...
connection.commit()
cursor.exeucte('INSERT INTO TaughtBy VALUES (9, "T0206", "CE2100")')
connection.commit()
cursor.execute('INSERt INTO TaughtBy VALUES (10, "R0106", "NE3200")')
connection.commit()
...
connection.commit()
cursor.execute('INSERT INTO Room VALUES ("Classroom", 101, "14 Mines")')
connection.commit()
cursor.execute('INSERT INTO Room VALUES ("Classroom", 101, "15 Mines")')
connection.commit()
...
connection.commit()
cursor.execute('INSERT INTO Takes VALUES (4, "T0206", "CE2100", 3.5)')
connection.commit()
cursor.execute('INSERT INTO Takes VALUES (5, "R0106", "NE3200", 3.7)')
connection.commit()
...
connection.commit()
cursor.execute('INSERT INTO ClassInRoom VALUES ("CE2100", "T0206", 101, "14 Mines")')
connection.commit()
cursor.execute('INSERT INTO ClassInRoom VALUES ("NE3200", "R0106", 101, "15 Mines")')
connection.commit()
